	...
	PATIENTSEARCH = {
		...
		*/
		...
		buildQuery: function(){
			...
			this.selectClause = "SELECT pt.patient_id, pi.identifier, pn.given_name, pn.middle_name, pn.family_name, ps.gender, ps.birthdate, EXTRACT(YEAR FROM (FROM_DAYS(DATEDIFF(NOW(),ps.birthdate)))) age, pn.person_name_id";
