...
public class GetHTMLObsController {
	...
	public String getHTMLObs(@RequestParam("name") String name, @RequestParam("type") String type, @RequestParam("title") String title, @RequestParam("data") String data, Model model) {
