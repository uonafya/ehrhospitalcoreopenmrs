...
public class AjaxController {
	...
	public String checkExistingForm(@RequestParam("conceptName") String conceptName, @RequestParam(value = "formId", required = false) Integer formId, Model model) {
		...
		if (concept != null) {
			...
			model.addAttribute("duplicatedFormFound", Boolean.valueOf(duplicatedFormFound));
