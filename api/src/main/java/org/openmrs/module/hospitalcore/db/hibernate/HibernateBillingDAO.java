...
public class HibernateBillingDAO implements BillingDAO {
	...
	/**
     * @see org.openmrs.module.billing.db.BillingDAO#listTenderBillByCompany(int, int, org.openmrs.module.billing.model.Company)
     */
    @SuppressWarnings("unchecked")
	...
	/**
     * @see org.openmrs.module.billing.db.BillingDAO#listAmbulanceBillByDriver(int, int, org.openmrs.module.billing.model.Driver)
     */
    @SuppressWarnings("unchecked")
	...
	/**
     * @see org.openmrs.module.billing.db.BillingDAO#listPatientServiceBillByDriver(int, int, org.openmrs.module.billing.model.Driver)
     */
    @SuppressWarnings("unchecked")
