...
public interface EhrTimeSlotDAO extends EhrSingleClassDAO {
     ...
     */
    List<EhrTimeSlot> getEhrTimeSlotsByConstraints(EhrAppointmentType appointmentType, Date fromDate, Date toDate, Provider provider)
            throws APIException;
     ...
     */
    List<EhrTimeSlot> getEhrTimeSlotsByAppointmentBlock(EhrAppointmentBlock appointmentBlock);
}
