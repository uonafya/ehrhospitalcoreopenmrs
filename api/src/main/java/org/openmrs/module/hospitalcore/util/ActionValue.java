...
public class ActionValue {
	public static final int[] DRUG_ATTRIBUTE = new int[] { 1, 2, 3 };

	public static final String[] DRUG_ATTRIBUTE_NAMES = new String[] { "A", "B", "C" };

	public static final int[] IS_DRUG = new int[] { 1, 2 };

	public static final String[] IS_DRUG_NAMES = new String[] { "Yes", "No" };

	public static final int[] ITEM_ATTRIBUTE = new int[] { 1, 2 };

	public static final String[] ITEM_ATTRIBUTE_NAMES = new String[] { "Essential Item", "Non Essential Item" };

	public static final int[] INDENT_SUBSTORE = new int[] { 1, 2, 3, 4, 5, 6 };

	public static final String[] INDENT_SUBSTORE_NAMES = new String[] { "SAVE", "SENT", "RECEIPT", "REFUSE", "DONE", "MAIN-STORE REFUSE" };

	public static final int[] TRANSACTION = new int[] { 1, 2 };

	public static final List<String> TRANSACTION_NAMES = Collections.unmodifiableList(Arrays.asList(new String[] { "RECEIPT", "ISSUE" }));
	...
	public static final int[] INDENT_MAINSTORE = new int[] { 1, 2, 3, 4 };

	public static final String[] INDENT_MAINSTORE_NAMES = new String[] { "WAIT PROCESS", "REFUSE", "DONE", "SUB-STORE REFUSE" };
