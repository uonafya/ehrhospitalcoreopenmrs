...
public class OpdPatientQueueLog implements Serializable {
	...
	public String toString() {
		return "OpdPatientQueueLog [id=" + this.id + ", patient=" + this.patient + ", patientName=" + this.patientName + ", birthDate=" + this.birthDate + ", sex=" + this.sex + ", referralConceptName=" + this.referralConceptName + ", referralConcept=" + this.referralConcept + ", opdConcept=" + this.opdConcept + ", opdConceptName=" + this.opdConceptName + ", status=" + this.status + ", user=" + this.user + ", createdOn=" + this.createdOn + ",encounter=" + this.encounter + ",visitOutCome=" + this.visitOutCome + " ,category=" + this.category + ",visitStatus=" + this.visitStatus + "]";
	}
