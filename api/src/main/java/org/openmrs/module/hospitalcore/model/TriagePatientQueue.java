...
public class TriagePatientQueue implements Serializable {
    ...
    public String toString() {
        return "TriagePatientQueue [id=" + this.id + ", patient=" + this.patient + ", patientName=" + this.patientName + ", birthDate=" + this.birthDate + ", sex=" + this.sex + ", referralConceptName=" + this.referralConceptName + ", referralConcept=" + this.referralConcept + ", opdConcept=" + this.triageConcept + ", triageConceptName=" + this.triageConceptName + ", status=" + this.status + ", user=" + this.user + ", createdOn=" + this.createdOn + " ,category=" + this.category + ",visitStatus=" + this.visitStatus + "]";
    }
