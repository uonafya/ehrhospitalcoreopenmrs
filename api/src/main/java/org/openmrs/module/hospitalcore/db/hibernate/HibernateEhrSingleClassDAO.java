...
import org.openmrs.module.hospitalcore.db.EhrSingleClassDAO;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.transaction.annotation.Transactional;

import java.util.List;

public abstract class HibernateEhrSingleClassDAO<T> implements EhrSingleClassDAO<T> {
    ...
    private HibernateEhrSingleClassDAO() {
    }
     ...
     * @param mappedClass
     */
    protected HibernateEhrSingleClassDAO(Class<T> mappedClass) {
